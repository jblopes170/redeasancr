-- Correcao para erro: Configuracao do portal pendente. Execute no Supabase SQL Editor.
-- Este arquivo aplica cadastro completo + portal + visibilidade publica em ordem.
...
-- Complemento: niveis separados em solicitacoes de inscricao.
