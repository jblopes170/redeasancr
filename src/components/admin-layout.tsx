  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 border-b border-white/10 bg-[#17100e]/95 text-white shadow-[0_10px_32px_rgba(32,12,7,0.25)] backdrop-blur-xl">
        <div className="mx-auto flex min-h-[66px] max-w-[1440px] items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <Button asChild size="sm" className="hidden bg-secondary text-secondary-foreground hover:bg-secondary/90 sm:inline-flex">
              {eventId ? (
      ...
      <main className="mx-auto w-full max-w-[1440px] px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        <header className="mb-7 flex flex-col gap-3 border-b border-border pb-5 md:flex-row md:items-end md:justify-between">
          <div>
